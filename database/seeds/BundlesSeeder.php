...
class BundlesSeeder extends Seeder
{
    ...
    public function run()
    {
      DB::table('bundles')->insert([
        ...
        'image' => 'https://img0.etsystatic.com/122/0/10924417/il_570xN.992662922_h0s7.jpg']);
      DB::table('bundles')->insert([
        'price' => 7.99,
      ...
      DB::table('bundles')->insert([
        ...
        'image' => 'https://img1.etsystatic.com/137/1/10924417/il_570xN.1007724873_tmic.jpg']);
      DB::table('bundles')->insert([
        'price' => 5.29,
        'name' => "Pokemon Set 4+5",
        'description' => "Any size of set4 and set5",
        'image' => 'https://img1.etsystatic.com/116/0/10924417/il_570xN.1022946671_kbul.jpg']);
